...
const PriceTrends = lazy(() => import('./components/views/Admin/PriceTrends').then(m => ({ default: m.PriceTrends })));
          ...
          <SidebarProvider>
            <Router>
              ...
              <Routes>
                  ...
                  <Route path="/settings/manage/archived-requests" element={
                    <ProtectedRoute requireAdmin>
                      <Layout>
                  ...
                  <Route path="/settings/manage/transactions" element={
                    <ProtectedRoute requireAdmin>
                      <Layout>
                        <TransactionsManager />
                      </Layout>
                  ...
                  <Route path="/settings/manage/price-trends" element={
                    <ProtectedRoute requireAdmin>
                      <Layout>
                        <PriceTrends />
                      </Layout>
