...
const SAFE_FIELDS = ['workerNote', 'engineerNote', 'requestorName', 'approverName', 'warehousemanName'];
const SENSITIVE_FIELDS = ['status', 'batchId', 'requestorId', 'approverId', 'warehousemanId'];
              ...
              return (
                <Card key={req.id} className={cn(
                  ...
                  <div className="p-3 space-y-0">
                    ...
                    <FieldRow req={req} field="requestorId" label="Requestor ID" />
                    <FieldRow req={req} field="approverName" label="Approver" />
                    <FieldRow req={req} field="approverId" label="Approver ID" />
                    <FieldRow req={req} field="warehousemanName" label="Warehouseman" />
                    <FieldRow req={req} field="warehousemanId" label="Warehouseman ID" />
                    <FieldRow req={req} field="batchId" label="Batch ID" />
